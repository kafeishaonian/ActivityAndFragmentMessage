...
import com.zhihu.client.butterKnife.OnClick;
import com.zhihu.client.butterKnife.ViewInject;
import com.zhihu.client.butterKnife.ViewUtilsTest;
import com.zhihu.client.fragment.BaseFragment;
import com.zhihu.client.fragment.MainFragment;
...
public class MainActivity extends BaseActivity {
    ...
    public void setFunctionsForFragment(int fragmentId) {
        ...
        switch (fragmentId) {
            case R.id.fragment_main:
                ...
                fragment.setFunctions(new Functions().addFunction(new Functions.FunctionNoParamAndResult(MainFragment.NO_PARAM_NO_RESULT) {
                    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentManager fm = getSupportFragmentManager();
        BaseFragment fragment = (BaseFragment) fm.findFragmentById(R.id.fragment_main);
        fragment.setFunctionsForFragment();
...
//        EventBus.getDefault().register(this);
    ...
    public void onClick(View view){
        switch (view.getId()) {
            case R.id.buttons:
//                Toast.makeText(MainActivity.this, "啦啦啦啦啦啦啦", Toast.LENGTH_SHORT).show();
                try {
                    functions.invokeFunc(NO);
...
//        Log.e("TAG", System.currentTimeMillis()+ "啦啦啦啦1230" );
//    }
